...
namespace AngularSPA.Api.Filters
{
        ...
        public override void OnActionExecuting(HttpActionContext actionContext) {
            ...
            foreach (var actionArgumentItem in actionContext.ActionArguments) {
                ...
                if (!validationResult.IsValid) {
                    var response = actionContext.Request.CreateResponse(HttpStatusCode.BadRequest, validationResult.Messages);
                    response.Headers.Add("Status-Reason", "validation-failed");
